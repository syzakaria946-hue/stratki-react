      ...
      <button className="fixed bottom-8 right-8 bg-blue-600 hover:bg-blue-700 text-white w-14 h-14 rounded flex items-center justify-center text-2xl shadow-lg transition">
        ↑
           ...
           <section id="services" className="min-h-screen flex items-center justify-center bg-white">
            <div className="text-center">
              <h2 className="text-5xl md:text-7xl font-extrabold text-slate-800 py-3">Our Services</h2>
            </div>

           </section>

           <div className=" grid sm:grid-cols-2 lg:grid-cols-3 gap-3 group my-20 mx-10 justify-center items-center p-20 py-30">
            {Service.map((item, index)=>(
              <div key={index} className="flex flex-col items-center justify-center sm:justify-self-start sm:items-start p-5">
            ...
            <section id="services" className="min-h-screen flex items-center justify-center bg-white">
            <div className="text-center">
              <h2 className="text-5xl md:text-7xl font-extrabold text-emerald-500 py-3">Our Skills
             ...
             <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
               {SkillsProp.map((item, index)=>(
                <CardSvg description={item.description} percentage={item.percentage} title={item.title} key={index}/>
              ))}
             </div>
           ...
           <div
            key={index}
            className="bg-gray-50 rounded-xl p-6 flex flex-col gap-2"
          >
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
        {team.map((member) => (
          ...
          >
            ...
            <div className="text-center">
              <h2 className="text-5xl md:text-7xl font-extrabold text-gray-700 py-3">Pricing Plan</h2>
            </div>
           <section id="services" className="min-h-screen flex fl items-center justify-center bg-white">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        {plans.map((plan) => (
          ...
          >
           ...
           <section id="services" className="min-h-screen flex items-center justify-center bg-white">
            <div className="text-center">
              <h2 className="text-5xl md:text-7xl font-extrabold text-slate-800 py-3">Testimonials</h2>
            </div>
